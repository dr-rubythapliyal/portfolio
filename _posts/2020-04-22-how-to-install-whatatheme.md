---
title: How to Install and use portfolio?
layout: post
post-image: https://raw.githubusercontent.com/thedevslot/portfolio/master/assets/images/How%20to%20install%20and%20use%20portfolio.png?token=AHMQUEPHRKQFL5FS624RDJ26Z64HK
description: This post will guide you to install portfolio on your Jekyll site, follow
  the easy steps to set up portfolio.
tags:
- how to
- setup
- theme
...
**portfolio** is a customizable Jekyll Portfolio theme which supports blogging. You can use this theme in order to create an elegant, fully responsive portfolio which includes
...
#### Extra Features -
portfolio comes pre installed with
...
* **Disqus** - A worldwide blog comment hosting service for web sites and online communities that use a networked platform. For more information about Disqus [click here](https://help.disqus.com/en/articles/1717053-what-is-disqus){:target="blank"}
	...
	##### For more information about portfolio [click here](https://github.com/thedevslot/portfolio/blob/gh-pages/README.md){:target="blank"}.

---

# Installation
### Step 1 - Setting up portfolio
> * Fork the [repository](https://github.com/thedevslot/portfolio/tree/master){:target="blankl"}
> * Go to repository settings and set Github Pages source as master.
> * Your new site should be ready at [https://username.github.io/portfolio/](#){:target="blank"}
